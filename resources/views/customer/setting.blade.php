                        ...
                        <div class="card">
                            <div class="card-body ">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ Auth::guard(session('guardName'))->user()->image }}" alt="customer" class="rounded-circle"
                                        width="186">
                        ...
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-md-2">
                                <div class="col-md-12"><label class="labels">Full Name</label><input type="text"
                                        class="form-control" placeholder="{{$customer->first_name . ' ' . $customer->last_name}}" value=""></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12 mt-2"><label class="labels">Mobile Number</label><input
                                        type="text" class="form-control" placeholder="{{$customer->phone_number}}" value="">
                                </div>
                                ...
                                <div class="col-md-12 mt-2"><label class="labels">Email address</label><input
                                        type="text" class="form-control" placeholder="{{$customer->email}}"
                                        value=""></div>
                            </div>
